...
def edit_product_request_list(request, pk):
    ...
    if request.method == "POST":
        ...
        if product_formset.is_valid():
            ...
            if request.user.has_perm('europarts_old_2.can_add_cost_price'):
                list_obj.cost_price_quoted = True
                list_obj.save()

            if request.user.has_perm('europarts_old_2.can_add_selling_price') and list_obj.cost_price_quoted:
