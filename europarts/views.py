...
class QuotationEmail(AtomicMixin, View, LoginRequiredMixin):
    ...
    def get(self, request, **kwargs):
        ...
        # task
        generate_pdf_and_send_email.delay(self.template, 'quotation_email.pdf', context, self.kwargs['pk'], 'quotation', subject, body, from_email, to)
...
class ChallanEmail(AtomicMixin, View, LoginRequiredMixin):
    ...
    def get(self, request, **kwargs):
        ...
        # task
        response = generate_pdf_and_send_email.delay(self.template, 'challan_email.pdf', context, self.kwargs['pk'], 'challan', subject, body, from_email, to)
        ...
        while True:
            if not response is None:
                email.attach('challan_email.pdf', response, 'application/pdf')
                break
