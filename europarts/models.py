...
class WorksheetRow(Timestamped):
    ...
    per_pcs_duty_tax = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True, default=800.0)
    air_freight_cost_p_pcs = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True, default=500.0)
