...
class WorksheetRowForm(forms.ModelForm):
    class Meta:
        model = WorksheetRow
        fields = ['part_no', 'barcode', 'description', 'quantity', 'gram_p_s', 'total', 'per_pcs_duty_tax', 'air_freight_cost_p_pcs', 'net_purchase_price_taka', 'tax', 'price_after_tax', 'unit_price_in_taka', 'brand', 'vat', 'total_price_in_taka']
